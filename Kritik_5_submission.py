...
# lies inside the triangle formed by A0, 0), (1, 0) and (0.5, 0.866)
...
for i in range(num_steps):
    ...
    x_value1, y_value1 = points[i-1]
    x_value2, y_value2 = next_vertex
    next_point = ((x_value1+x_value2)/2, (y_value1+y_value2)/2)
